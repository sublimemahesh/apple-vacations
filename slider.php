<div id="full-slider-wrapper">
    <div id="layerslider" style="width:100%;height:750px;">
        ...
        foreach ($SLIDER->all() as $key => $slider) {
            ?>
            <div class="ls-slide" data-ls="slidedelay: 5000; transition2d:<?php echo $key ?>;">
                <img src="upload/slider/<?php echo $slider['image_name'] ?>" class="ls-bg" alt="Slide background">
                <h3 class="ls-l slide_typo" style="top: 45%; left: 50%;text-shadow: 0 2px 5px rgba(0, 0, 0, .5); font-size: 50px; font-family: 'Oswald', sans-serif; " data-ls="offsetxin:0;durationin:2000;delayin:1000;easingin:easeOutElastic;rotatexin:90;transformoriginin:50% bottom 0;offsetxout:0;rotatexout:90;transformoriginout:50% bottom 0;"  ><?php echo $slider['title'] ?></h3>
                <p class="ls-l slide_typo_2" style="top:52%; left:50%;" data-ls="durationin:2000;delayin:1000;easingin:easeOutElastic;"><?php echo $slider['title'] ?></p>
