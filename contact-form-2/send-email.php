...
if ($_SESSION['CAPTCHACODES'] != $_POST['captchaCode']) {
...
$visitor_adults = $_POST['visitor_adults'];
$visitor_childs = $_POST['visitor_childs'];
$visitor_nationality = $_POST['visitor_nationality'];
