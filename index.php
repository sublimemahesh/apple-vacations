                            ...
                            <div id="round_tour" 
                                 <div class="description">
                                    <div class="col-md-12">
                                        ...
                                        foreach ($TOUR_PACKAGE->getTourPackagesByType(1) as $key => $tour_package) {
                                            if ($key < 12) {
                                                ?> 
                                                <a href="view-tour-package.php?id=<?php echo $tour_package['id'] ?>" >  
                                                    <div class="col-md-3 col-xs-4 col-sm-4">
                                                        <img src="upload/tour-package/<?php echo $tour_package['image_name'] ?>" alt="<?php echo $tour_package['title'] ?>" class="img-responsive img-res-p "  />
                                                        <div class="carousel-caption padd-top-cap">
                                                            <p  class="white-color font-newsize-2"><?php echo $tour_package['title'] ?></p>
                                                        </div>
                                                    </div>
                                                </a>
                                                <?php
                            ...
                            <div id="one_day" class="tab-content search-width">
                                <div class="review-list-sec">
                                    <div class="col-md-12">
                                        <?php
                                        $TOUR_PACKAGE = new TourPackage(NULL);
                                        foreach ($TOUR_PACKAGE->getTourPackagesByType(2) as $key => $tour_package) {
                                            if ($key < 8) {
                                                ?> 
                                                <a href="view-tour-package.php?id=<?php echo $tour_package['id'] ?>" >  
                                                    <div class="col-md-3 col-xs-4 col-sm-4">
