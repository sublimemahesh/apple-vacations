                ...
                <div class="container"> 
                    <div class="  column"> 
                        <div class="row">  
                            <div class="col-md-12">
                                <h2>Tour Date 1</h2>
                                <p class="text-justify padd-tour-desc"> 
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="related-products">
                                    ...
                                    <div class="row" id="related-carousel-tour">
                                        <div class="col-md-4"   >
                                            <div class="listing-box ">
                                                ...
                                                <div class="tour-list-bottom text-justify ">
                                                    ...
                                                    <a href="view-tour-packages.php">   <div class="col-md-4 tour-btn"  >
