...
<html>
    <head>
        ...
        <title>Tour Packages - Apple vacation</title>
    ...
    <body>
        ...
        <div class="theme-layout">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="inner-header">
                                    <h2>Tours , Activities, Attractions</h2>
                                    <ul class="breadcrumbs">
                                        <li><a href="index.php" title="">Home</a></li>
                                        <li><a href="#" title="">Tours , Activities, Attractions</a></li> 
                                    </ul>	
                                </div>
                            </div>
                        </div>
            ...
            <section>
                <div class="container">
                    <div class="row" >
                        <div class="bokunWidget" data-src="https://widgets.bokun.io/online-sales/3fd3d93d-2ab1-4ff9-aec5-c5071443f013/product-list/13104"></div>
